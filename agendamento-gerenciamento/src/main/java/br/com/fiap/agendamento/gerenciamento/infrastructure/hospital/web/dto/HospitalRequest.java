...
public record HospitalRequest(
        ...
        String telefone,
        @NotNull(message = "O campo diaSemanaInicio é obrigatório.")
        DayOfWeek diaSemanaInicio,
        @NotNull(message = "O campo diaSemanaFim é obrigatório.")
        DayOfWeek diaSemanaFim,
        @NotNull(message = "O campo horaInicio é obrigatório.")
        LocalTime horaInicio,
        @NotNull(message = "O campo horaFim é obrigatório.")
        LocalTime horaFim,
        @NotNull(message = "O campo tempoLimiteCancelamentoMinutos é obrigatório.")
        @PositiveOrZero(message = "O tempo limite de cancelamento deve ser maior ou igual a zero.")
        Integer tempoLimiteCancelamentoMinutos,
        @NotNull(message = "O campo tempoToleranciaPosConsultaMinutos é obrigatório.")
        @PositiveOrZero(message = "O tempo de tolerância para consulta deve ser maior ou igual a zero.")
        Integer tempoToleranciaPosConsultaMinutos,
        @NotNull(message = "O campo tempoMinimoConsultaMinutos é obrigatório.")
        @Positive(message = "O tempo mínimo de duração de cada consulta deve ser maior que zero.")
        Integer tempoMinimoConsultaMinutos
) {
}
